...
/**
 * //TODO: ошибочный файл - оставлю пока на случай, может пригодится для другого формата
 *
 * Class Format_DebtorsExcelType1
 * @package common\models\debtor_parse
 */
class Format_DebtorsExcelType1
{
    /**
     * Форматирование "сырого" формата
     *
