...
$attributes = [
    ...
    [
        ...
        'value' => $model->legalAddressLocation ? $model->legalAddressLocation->createFullAddress([], 'оф.') : '',   //'<button>Изменить</button>',
    ...
    [
        ...
        'value' => $model->actualAddressLocation ? $model->actualAddressLocation->createFullAddress([], 'оф.') : '',
        'type' => DetailView::INPUT_TEXT,
        'options' => [
            'readonly' => 'readonly',
        ],
    ...
    [
        ...
        'value' => $model->postalAddressLocation ? $model->postalAddressLocation->createFullAddress([], 'оф.') : '',
        'type' => DetailView::INPUT_TEXT,
        'options' => [
            'readonly' => 'readonly',
        ],
