...
<p>Таким образом, размер задолженность ответчиков перед <?= Html::encode($company->short_name) ?> за период с
    ...
    <?= Html::encode($debtor->getDebtTotal()) ?> руб. Неустойка за просрочку платежа на дату подачи заявления составляет
    <?= Html::encode($debtor->getFineTotal()) ?> руб.</p>
    <p>Руководствуясь п. 3 ст. 382 Гражданского кодекса РФ, и в соответствии с договором уступки прав (цессии) №
        2706/2017
